...
Environmental data has been pre-processed in the script "env_preprocess.Rmd". Here I just double check that everything looks right and is in the correct order to match with genomic data.
