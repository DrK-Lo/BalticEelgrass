...
# save offsets
write.csv(offsets_rda, paste0("results/GO_results/RDA_offsets_exptrt_long_unscaled_",Sys.Date(),".csv"))
write.csv(offsets_rda_wide, paste0("results/GO_results/RDA_offsets_exptrt_wide_unscaled_",Sys.Date(),".csv"))
```
...
ggplot(offsets_rda_plotting, aes(x = fct_reorder(pop, order), y = trt, fill = (offset_mll))) +
  ...
  scale_fill_viridis_c(option = "magma", direction = -1, limits = c(0,20)) +
  theme_classic() +
...
cor(offsets_rda$offset_mll, offsets_rda$offset_full) # 0.975 correlation
```
