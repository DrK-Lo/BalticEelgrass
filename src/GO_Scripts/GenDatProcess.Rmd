...
# also trim vcfs
sites_rm_full <- which(gen_full_imp_df %in% gen_full_imp_trim)
sites_rm_mll <- which(gen_MLL_imp_df %in% gen_MLL_imp_trim)

vcf_full_trim <- vcf_full[sites_rm_full,]
vcf_mll_trim <- vcf_mll[sites_rm_mll,]

# rewrite vcf files
write.vcf(vcf_full_trim, "data/seascape_data/vcf_full_trimmed.vcf")
write.vcf(vcf_mll_trim, "data/seascape_data/vcf_mll_trimmed.vcf")
